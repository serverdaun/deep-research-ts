...
export const transformMessagesIntoResearchTopicPrompt = `ou will be given a set of messages that have been exchanged so far between yourself and the user. 
